...
awaitable_t<tlsuv_http_resp_t*> tlsuv_http_req_wait(tlsuv_http_req_t* req)
{
  awaitable_state<tlsuv_http_resp_t*> state;
  co_return co_await tlsuv_http_req_wait(state, req);
}

tlsuv_http_req_t* tlsuv_http_req(tlsuv_http_t* clt, const char* method, const char* path)
{
...
awaitable_t<int> tlsuv_http_close(tlsuv_http_t* clt)
{
